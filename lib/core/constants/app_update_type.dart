...
enum AppUpdateType { MINOR, MAJOR, OPTIONAL }

extension AppUpdateTypeExtension on AppUpdateType {
  String get titleTranslationKey => switch (this) {
    AppUpdateType.MINOR => LocaleKeys.enums_appVersionTranslationsTitle_MINOR,
    AppUpdateType.MAJOR => LocaleKeys.enums_appVersionTranslationsTitle_MAJOR,
    _ => '',
  };
